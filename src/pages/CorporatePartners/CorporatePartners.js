        ...
        <div className="corporate-partners-page">
            <div className="Title-Slider">
                ...
                <div className="multi-button">
                    <button className={activeSection === 'tech' ? 'active' : ''} onClick={() => handleSectionClick('tech')}>
                        <FontAwesomeIcon icon={faLaptopCode} /> Tech
                    </button>
                    <button className={activeSection === 'consulting' ? 'active' : ''} onClick={() => handleSectionClick('consulting')}>
                        <FontAwesomeIcon icon={faUserTie} /> Consulting
                    </button>
                    <button className={activeSection === 'banking' ? 'active' : ''} onClick={() => handleSectionClick('banking')}>
                        <FontAwesomeIcon icon={faPiggyBank} /> Banking
                    </button>
                </div>
            </div>
            <div className="main-section">
                <CorporateLogos displayedLogos={updatedCompanyStats.map(company => company.logo)} handleLogoClick={handleLogoClick} showStatistics={showStatistics} selectedLogoIndex={selectedLogoIndex}/>
            </div>
        </div>
    );
